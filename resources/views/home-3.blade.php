...
<nav class="mob-main-mnu">
    ...
    <div class="mob-main-mnu-footer">
        <ul class="mob-main-mnu-lang">
            <li class="active"><a href="home-3.html#!"><span>En</span></a></li>
            <li><a href="home-3.html#!"><span>Sp</span></a></li>
            <li><a href="home-3.html#!"><span>It</span></a></li>
            <li><a href="home-3.html#!"><span>Uk</span></a></li>
            <li><a href="home-3.html#!"><span>Ru</span></a></li>
        </ul>
    </div>
...
<nav class="main-mnu">
    <ul class="main-mnu-list">
        ...
        <li class="main-mnu-item-has-child open main-mnu-item-mega-mnu">
            <a href="home-3.html#!" data-title="Pages">
                <span>Pages</span>
                <i class="material-icons">expand_more</i>
            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 main-sub-mnu-banner">
                            <div class="main-sub-mnu-slider" data-flickity='{ "bgLazyLoad": 1, "bgLazyLoad": true, "fade": true, "prevNextButtons": true, "pageDots": false, "pauseAutoPlayOnHover": false }'>
                                <a href="home-3.html#!" class="mnu-slider-item align-items-end" data-flickity-bg-lazyload="assets/img/mnu-banner.jpg">
                                    <div>
                                ...
                                <li class="d-none d-lg-block">
                                    <div class="header-lang">
                                        ...
                                        <ul class="header-lang-list">
                                            <li><a href="home-3.html#!" class="hover-link" data-lang="En" data-title="English"><span>English</span></a></li>
                                            <li><a href="home-3.html#!" class="hover-link" data-lang="Sp" data-title="Spanish"><span>Spanish</span></a></li>
                                            <li><a href="home-3.html#!" class="hover-link" data-lang="It" data-title="Italian"><span>Italian</span></a></li>
                                            <li><a href="home-3.html#!" class="hover-link" data-lang="Uk" data-title="Ukraine"><span>Ukraine</span></a></li>
                                            <li><a href="home-3.html#!" class="hover-link" data-lang="Ru" data-title="Russian"><span>Russian</span></a></li>
                                        </ul>
                                    </div>
...
<div class="section-bg intro">
    <div class="intro-slider flickity-dots-absolute" data-flickity='{ "bgLazyLoad": 1, "bgLazyLoad": true, "fade": true, "prevNextButtons": false, "autoPlay": 7000, "pauseAutoPlayOnHover": false }'>
        ...
        <div class="intro-item" data-flickity-bg-lazyload="assets/img/intro-img5.jpg">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="intro-content">
        ...
        <div class="intro-item" data-flickity-bg-lazyload="assets/img/intro-img6.jpg">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="intro-content">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-4 col-md-6 col-12 item">
                <!-- Begin services item -->
                <a href="single-services.html" class="services-item services-item-row item-style">
                    ...
                    <div class="services-item-info">
                        ...
                        <div class="services-item-desc">Need specific software for your company? We are ready to develop it!</div>
                    </div>
                </a><!-- End services item -->
            </div>
            <div class="col-xl-4 col-md-6 col-12 item">
                ...
                <a href="single-services.html" class="services-item services-item-row item-style">
                    ...
                    <div class="services-item-info">
                        ...
                        <div class="services-item-desc">Our experts provide custom products of any complexity for call centers.</div>
                    </div>
                </a><!-- End services item -->
            </div>
            <div class="col-xl-4 col-md-12 col-12 item">
                ...
                <a href="single-services.html" class="services-item services-item-row item-style">
                    ...
                    <div class="services-item-info">
                        ...
                        <div class="services-item-desc">We can also offer you reliable cloud  development solutions.</div>
                    </div>
                </a><!-- End services item -->
            </div>
            <div class="col-12">
    ...
    <div class="section-row">
        ...
        <div class="section-item d-none d-lg-block">
            <picture class="section-right-picture lazy">
                <source srcset="assets/img/img-1.jpg" media="(min-width: 992px)">
            </picture>
        </div>
    </div>
            ...
            <div class="col-xl-3 col-md-6 col-12 item">
                <div class="counter-min">
                    <div class="counter-min-block">
                        ...
                        <div class="counter-min-numb"><span class="spincrement" data-from="0" data-to="2">0</span>К</div>
                    </div>
                    <div class="counter-min-info">
...
<section class="section section-projects section-overflow-hidden section-bg">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-btns justify-content-center">
                    <a href="home-3.html#!" class="btn btn-with-icon btn-w240 ripple">
            ...
            <div class="row items">
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-7 item">
                    <div class="footer-item">
                        ...
                        <nav class="footer-nav">
                            <ul class="footer-mnu">
                                <li><a href="home-3.html#!" class="hover-link" data-title="DB Management"><span>DB Management</span></a></li>
                                <li><a href="home-3.html#!" class="hover-link" data-title="IOS/MacOS"><span>IOS/MacOS</span></a></li>
                                <li><a href="home-3.html#!" class="hover-link" data-title="Android Apps"><span>Android Apps</span></a></li>
                                <li><a href="home-3.html#!" class="hover-link" data-title="Windows Apps"><span>Windows Apps</span></a></li>
                                <li><a href="home-3.html#!" class="hover-link" data-title="UX & UI"><span>UX & UI</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="footer-contacts">
                            ...
                            <li>
                                ...
                                <div class="footer-contact-info">
                                    <a href="home-3.html#!" class="formingHrefTel">+1 323-913-4688</a>, <a href="home-3.html#!" class="formingHrefTel">+1 323-888-4554</a>
                                </div>
                            </li>
                            <li>

...
<nav class="mob-main-mnu">
    ...
    <div class="mob-main-mnu-footer">
        <ul class="mob-main-mnu-lang">
            <li class="active"><a href="home-4.html#!"><span>En</span></a></li>
            <li><a href="home-4.html#!"><span>Sp</span></a></li>
            <li><a href="home-4.html#!"><span>It</span></a></li>
            <li><a href="home-4.html#!"><span>Uk</span></a></li>
            <li><a href="home-4.html#!"><span>Ru</span></a></li>
        </ul>
    </div>
...
<nav class="main-mnu">
    <ul class="main-mnu-list">
        ...
        <li class="main-mnu-item-has-child open main-mnu-item-mega-mnu">
            <a href="home-4.html#!" data-title="Pages">
                <span>Pages</span>
                <i class="material-icons">expand_more</i>
            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 main-sub-mnu-banner">
                            <div class="main-sub-mnu-slider" data-flickity='{ "bgLazyLoad": 1, "bgLazyLoad": true, "fade": true, "prevNextButtons": true, "pageDots": false, "pauseAutoPlayOnHover": false }'>
                                <a href="home-4.html#!" class="mnu-slider-item align-items-end" data-flickity-bg-lazyload="assets/img/mnu-banner.jpg">
                                    <div>
                                ...
                                <li class="d-none d-lg-block">
                                    <div class="header-lang">
                                        ...
                                        <ul class="header-lang-list">
                                            <li><a href="home-4.html#!" class="hover-link" data-lang="En" data-title="English"><span>English</span></a></li>
                                            <li><a href="home-4.html#!" class="hover-link" data-lang="Sp" data-title="Spanish"><span>Spanish</span></a></li>
                                            <li><a href="home-4.html#!" class="hover-link" data-lang="It" data-title="Italian"><span>Italian</span></a></li>
                                            <li><a href="home-4.html#!" class="hover-link" data-lang="Uk" data-title="Ukraine"><span>Ukraine</span></a></li>
                                            <li><a href="home-4.html#!" class="hover-link" data-lang="Ru" data-title="Russian"><span>Russian</span></a></li>
                                        </ul>
                                    </div>
...
<div class="section-bg intro">
    <div class="intro-slider flickity-dots-absolute flickity-dots-white" data-flickity='{ "bgLazyLoad": 1, "bgLazyLoad": true, "fade": true, "prevNextButtons": false, "autoPlay": 7000, "pauseAutoPlayOnHover": false }'>
        <div class="intro-item intro-item-mob-dark" data-flickity-bg-lazyload="assets/img/intro-img7.jpg">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="intro-box">
        ...
        <div class="intro-item intro-item-mob-dark" data-flickity-bg-lazyload="assets/img/intro-img8.jpg">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="intro-box">
        ...
        <div class="intro-item intro-item-mob-dark" data-flickity-bg-lazyload="assets/img/intro-img9.jpg">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="intro-box">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 item">
                <!-- Begin services item -->
                <a href="single-services.html" class="services-item services-item-modern item-style">
                ...
                <div class="reviews-carusel" data-flickity='{ "imagesLoaded": true, "lazyLoad": true, "groupCells": true, "contain": true, "prevNextButtons": false }'>
                        ...
                        <div class="reviews-item item-style">
                            <div class="reviews-item-header">
                                <div class="reviews-item-img">
                                    <img data-flickity-lazyload="assets/img/auth-img-1.jpg"
                                ...
                                <div class="reviews-item-info">
                                    <h4 class="reviews-item-title">Catherine Williams</h4>
                    ...
                    <div class="reviews-col">
                        <div class="reviews-item item-style">
                            <div class="reviews-item-header">
                                <div class="reviews-item-img">
                                    <img data-flickity-lazyload="assets/img/auth-img-2.jpg"
                                        src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                        alt="">
                                </div>
                                <div class="reviews-item-info">
                                    <h4 class="reviews-item-title">Rupert Wood</h4>
                                    <div class="reviews-item-position">Regular client</div>
                                </div>
                            </div>
                            <div class="reviews-item-text">
                                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Soluta deserunt quia et odio minima fuga optio quibusdam, aut eveniet atque ut mollitia dolores numquam ducimus velit vel repudiandae veritatis veniam!</p>
                            </div>
                        </div>
                    </div>
                    <div class="reviews-col">
                        <div class="reviews-item item-style">
                            <div class="reviews-item-header">
                                <div class="reviews-item-img">
                                    <img data-flickity-lazyload="assets/img/auth-img-3.jpg"
                                        src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                        alt="">
                                </div>
                                <div class="reviews-item-info">
                                    <h4 class="reviews-item-title">Samantha Brown</h4>
                                    <div class="reviews-item-position">Regular client</div>
                                </div>
                            </div>
                            <div class="reviews-item-text">
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere culpa impedit nisi aliquid nam expedita vel libero maxime reiciendis vitae aliquam ad quas, harum laborum, perferendis iure aut nulla saepe.</p>
                            </div>
                        </div>
                    </div>
                    <div class="reviews-col">
                        <div class="reviews-item item-style">
                            ...
                            <div class="reviews-item-text">
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam possimus, doloremque explicabo ullam fuga sint natus impedit!</p>
                            </div>
                        </div>
                    </div>
                    <div class="reviews-col">
                    ...
                    <div class="reviews-col">
                        <div class="reviews-item item-style">
                            ...
                            <div class="reviews-item-text">
                                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aspernatur veniam asperiores magni voluptas, culpa odit aliquid alias dolore ullam quod ab dolorem neque autem repellat dolores iure sit vitae officiis.</p>
                            </div>
                        </div>
                    </div>
                    <div class="reviews-col">
            ...
            <div class="row items">
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-7 item">
                    <div class="footer-item">
                        ...
                        <nav class="footer-nav">
                            <ul class="footer-mnu">
                                <li><a href="home-4.html#!" class="hover-link" data-title="DB Management"><span>DB Management</span></a></li>
                                <li><a href="home-4.html#!" class="hover-link" data-title="IOS/MacOS"><span>IOS/MacOS</span></a></li>
                                <li><a href="home-4.html#!" class="hover-link" data-title="Android Apps"><span>Android Apps</span></a></li>
                                <li><a href="home-4.html#!" class="hover-link" data-title="Windows Apps"><span>Windows Apps</span></a></li>
                                <li><a href="home-4.html#!" class="hover-link" data-title="UX & UI"><span>UX & UI</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="footer-contacts">
                            ...
                            <li>
                                ...
                                <div class="footer-contact-info">
                                    <a href="home-4.html#!" class="formingHrefTel">+1 323-913-4688</a>, <a href="home-4.html#!" class="formingHrefTel">+1 323-888-4554</a>
                                </div>
                            </li>
                            <li>

...
<nav class="mob-main-mnu">
    ...
    <div class="mob-main-mnu-footer">
        <ul class="mob-main-mnu-lang">
            <li class="active"><a href="news-post.html#!"><span>En</span></a></li>
            <li><a href="news-post.html#!"><span>Sp</span></a></li>
            <li><a href="news-post.html#!"><span>It</span></a></li>
            <li><a href="news-post.html#!"><span>Uk</span></a></li>
            <li><a href="news-post.html#!"><span>Ru</span></a></li>
        </ul>
    </div>
...
<nav class="main-mnu">
    <ul class="main-mnu-list">
        ...
        <li class="main-mnu-item-has-child open main-mnu-item-mega-mnu">
            <a href="news-post.html#!" data-title="Pages">
                <span>Pages</span>
                <i class="material-icons">expand_more</i>
            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 main-sub-mnu-banner">
                            <div class="main-sub-mnu-slider" data-flickity='{ "bgLazyLoad": 1, "bgLazyLoad": true, "fade": true, "prevNextButtons": true, "pageDots": false, "pauseAutoPlayOnHover": false }'>
                                <a href="news-post.html#!" class="mnu-slider-item align-items-end" data-flickity-bg-lazyload="assets/img/mnu-banner.jpg">
                                    <div>
                                ...
                                <li class="d-none d-lg-block">
                                    <div class="header-lang">
                                        ...
                                        <ul class="header-lang-list">
                                            <li><a href="news-post.html#!" class="hover-link" data-lang="En" data-title="English"><span>English</span></a></li>
                                            <li><a href="news-post.html#!" class="hover-link" data-lang="Sp" data-title="Spanish"><span>Spanish</span></a></li>
                                            <li><a href="news-post.html#!" class="hover-link" data-lang="It" data-title="Italian"><span>Italian</span></a></li>
                                            <li><a href="news-post.html#!" class="hover-link" data-lang="Uk" data-title="Ukraine"><span>Ukraine</span></a></li>
                                            <li><a href="news-post.html#!" class="hover-link" data-lang="Ru" data-title="Russian"><span>Russian</span></a></li>
                                        </ul>
                                    </div>
					...
					<div class="row">
						<div class="col-12">
							<ul class="bread-crumbs-list">
								...
								<li><a href="news-post.html#!">Benefits Of ASync/Await In Programming</a></li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div class="news-post">
								<header class="news-post-header">
									...
									<div class="news-post-meta">
										...
										<div class="news-post-meta-item">
											<span>by &nbsp;</span>
											<a href="news-post.html#!">John Doe</a>
										</div>
										<div class="news-post-meta-item">
									...
									<div class="news-post-img img-style">
										<img data-src="assets/img/news-post.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
									</div>
								</header>
									...
									<div class="row align-items-center justify-content-between items">
										<div class="col-md col-12 item">
											<ul class="news-post-cat">
												<li><a href="news-post.html#!">Startup</a></li>
												<li><a href="news-post.html#!">Software Development</a></li>
											</ul>
										</div>
													...
													<div class="comment-item-row">
														<header class="comment-item-header">
															<div class="row">
																...
																<div class="col-auto">
																	<a href="news-post.html#!" class="comment-item-reply">Reply</a>
																</div>
															</div>
														</header>
...
<aside class="sidebar items">
    <div class="sidebar-item item">
        <form action="#!" method="post">
            <div class="form-field">
                ...
                <input type="search" class="form-field-input" name="Search" value="" autocomplete="off" required="required" id="sidebar-field-search">
    ...
    <div class="sidebar-item item">
        <div class="section-bg item-border-radius sibebar-item-bg">
            <p class="sidebar-item-title item-heading">Sign Up to News</p>
            <p class="sidebar-item-desc">Subscribe to our news to get the latest updates and offers</p>
            <form action="#!" method="post" class="subscribe-news-form">
                <div class="form-field">
                    <label for="subscribe-news-email" class="form-field-label">Your Email</label>
                    <input type="email" class="form-field-input" name="SubscribeEmail" value="" autocomplete="off" required="required" id="subscribe-news-email">
                </div>
                <div class="form-btn">
    ...
    <div class="sidebar-item item">
        <p class="sidebar-item-title item-heading">Featured Tags</p>
        <ul class="sidebar-tags">
            <li><a href="news-post.html#!">Software</a></li>
            <li><a href="news-post.html#!">Development</a></li>
            <li><a href="news-post.html#!">Programming</a></li>
            <li><a href="news-post.html#!">Software</a></li>
            <li><a href="news-post.html#!">Development</a></li>
            <li><a href="news-post.html#!">IT</a></li>
        </ul>
    </div>
    <div class="sidebar-item item">
        <p class="sidebar-item-title item-heading">Recent Posts</p>
        <ul class="sidebar-recent-posts">
            <li>
                <a href="news-post.html#!" class="sidebar-recent-post">
                    <div class="sidebar-recent-post-img img-style">
                        <img data-src="assets/img/news-img-2.jpg" class="lazy" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="">
                    </div>
                    <div class="sidebar-recent-post-title">Benefits of Async/Await in Programming</div>
                </a>
            </li>
            <li>
                <a href="news-post.html#!" class="sidebar-recent-post">
                    ...
                    <div class="sidebar-recent-post-title">Key Considerations and Warnings of iPaaS</div>
                </a>
            </li>
            <li>
                <a href="news-post.html#!" class="sidebar-recent-post">
    ...
    <div class="sidebar-item item">
        <div class="section-bg item-border-radius sibebar-item-bg">
            <p class="sidebar-item-title item-heading">Categories</p>
            <ul class="sidebar-cat">
                <li class="sidebar-cat-item">
                    <a href="news-post.html#!" class="sidebar-cat-link">Startup</a>
                    <span class="sidebar-cat-count">25</span>
                </li>
                <li class="sidebar-cat-item">
                    <a href="news-post.html#!" class="sidebar-cat-link">Software Development</a>
                    <span class="sidebar-cat-count">14</span>
                </li>
                <li class="sidebar-cat-item">
                    <a href="news-post.html#!" class="sidebar-cat-link">Hybrid Cloud Management</a>
                    <span class="sidebar-cat-count">20</span>
                </li>
                <li class="sidebar-cat-item">
                    <a href="news-post.html#!" class="sidebar-cat-link">Software Solutions</a>
                    <span class="sidebar-cat-count">3</span>
                </li>
                <li class="sidebar-cat-item">
                    <a href="news-post.html#!" class="sidebar-cat-link">Creating Better Software</a>
                    <span class="sidebar-cat-count">18</span>
                </li>
                <li class="sidebar-cat-item">
                    <a href="news-post.html#!" class="sidebar-cat-link">Through Design Thinking</a>
            ...
            <div class="row items">
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-7 item">
                    <div class="footer-item">
                        ...
                        <nav class="footer-nav">
                            <ul class="footer-mnu">
                                <li><a href="news-post.html#!" class="hover-link" data-title="DB Management"><span>DB Management</span></a></li>
                                <li><a href="news-post.html#!" class="hover-link" data-title="IOS/MacOS"><span>IOS/MacOS</span></a></li>
                                <li><a href="news-post.html#!" class="hover-link" data-title="Android Apps"><span>Android Apps</span></a></li>
                                <li><a href="news-post.html#!" class="hover-link" data-title="Windows Apps"><span>Windows Apps</span></a></li>
                                <li><a href="news-post.html#!" class="hover-link" data-title="UX & UI"><span>UX & UI</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="footer-contacts">
                            ...
                            <li>
                                ...
                                <div class="footer-contact-info">
                                    <a href="news-post.html#!" class="formingHrefTel">+1 323-913-4688</a>, <a href="news-post.html#!" class="formingHrefTel">+1 323-888-4554</a>
                                </div>
                            </li>
                            <li>

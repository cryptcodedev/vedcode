...
<nav class="mob-main-mnu">
    <div class="mob-main-mnu-content">
        <ul class="mob-main-mnu-list">
            ...
            <li>
                <a href="services-2.html#!">Pages</a>
                <div class="mmm-btn"><i class="material-icons md-24">expand_more</i></div>
                <div class="mob-main-submnu">
                    <div class="mob-main-submnu-item">
    ...
    <div class="mob-main-mnu-footer">
        <ul class="mob-main-mnu-lang">
            <li class="active"><a href="services-2.html#!"><span>En</span></a></li>
            <li><a href="services-2.html#!"><span>Sp</span></a></li>
            <li><a href="services-2.html#!"><span>It</span></a></li>
            <li><a href="services-2.html#!"><span>Uk</span></a></li>
            <li><a href="services-2.html#!"><span>Ru</span></a></li>
        </ul>
    </div>
...
<nav class="main-mnu">
    <ul class="main-mnu-list">
        ...
        <li class="main-mnu-item-has-child open main-mnu-item-mega-mnu">
            <a href="services-2.html#!" data-title="Pages">
                <span>Pages</span>
                <i class="material-icons">expand_more</i>
            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 main-sub-mnu-banner">
                            <div class="main-sub-mnu-slider" data-flickity='{ "bgLazyLoad": 1, "bgLazyLoad": true, "fade": true, "prevNextButtons": true, "pageDots": false, "pauseAutoPlayOnHover": false }'>
                                <a href="services-2.html#!" class="mnu-slider-item align-items-end" data-flickity-bg-lazyload="assets/img/mnu-banner.jpg">
                                    <div>
                                ...
                                <li class="d-none d-lg-block">
                                    <div class="header-lang">
                                        ...
                                        <ul class="header-lang-list">
                                            <li><a href="services-2.html#!" class="hover-link" data-lang="En" data-title="English"><span>English</span></a></li>
                                            <li><a href="services-2.html#!" class="hover-link" data-lang="Sp" data-title="Spanish"><span>Spanish</span></a></li>
                                            <li><a href="services-2.html#!" class="hover-link" data-lang="It" data-title="Italian"><span>Italian</span></a></li>
                                            <li><a href="services-2.html#!" class="hover-link" data-lang="Uk" data-title="Ukraine"><span>Ukraine</span></a></li>
                                            <li><a href="services-2.html#!" class="hover-link" data-lang="Ru" data-title="Russian"><span>Russian</span></a></li>
                                        </ul>
                                    </div>
            ...
            <div class="row items">
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-7 item">
                    <div class="footer-item">
                        ...
                        <nav class="footer-nav">
                            <ul class="footer-mnu">
                                <li><a href="services-2.html#!" class="hover-link" data-title="DB Management"><span>DB Management</span></a></li>
                                <li><a href="services-2.html#!" class="hover-link" data-title="IOS/MacOS"><span>IOS/MacOS</span></a></li>
                                <li><a href="services-2.html#!" class="hover-link" data-title="Android Apps"><span>Android Apps</span></a></li>
                                <li><a href="services-2.html#!" class="hover-link" data-title="Windows Apps"><span>Windows Apps</span></a></li>
                                <li><a href="services-2.html#!" class="hover-link" data-title="UX & UI"><span>UX & UI</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="footer-contacts">
                            ...
                            <li>
                                ...
                                <div class="footer-contact-info">
                                    <a href="services-2.html#!" class="formingHrefTel">+1 323-913-4688</a>, <a href="services-2.html#!" class="formingHrefTel">+1 323-888-4554</a>
                                </div>
                            </li>
                            <li>

...
<nav class="mob-main-mnu">
    ...
    <div class="mob-main-mnu-footer">
        <ul class="mob-main-mnu-lang">
            <li class="active"><a href="home-2.html#!"><span>En</span></a></li>
            <li><a href="home-2.html#!"><span>Sp</span></a></li>
            <li><a href="home-2.html#!"><span>It</span></a></li>
            <li><a href="home-2.html#!"><span>Uk</span></a></li>
            <li><a href="home-2.html#!"><span>Ru</span></a></li>
        </ul>
    </div>
...
<nav class="main-mnu">
    <ul class="main-mnu-list">
        ...
        <li class="main-mnu-item-has-child open main-mnu-item-mega-mnu">
            <a href="home-2.html#!" data-title="Pages">
                <span>Pages</span>
                <i class="material-icons">expand_more</i>
            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 main-sub-mnu-banner">
                            <div class="main-sub-mnu-slider" data-flickity='{ "bgLazyLoad": 1, "bgLazyLoad": true, "fade": true, "prevNextButtons": true, "pageDots": false, "pauseAutoPlayOnHover": false }'>
                                <a href="home-2.html#!" class="mnu-slider-item align-items-end" data-flickity-bg-lazyload="assets/img/mnu-banner.jpg">
                                    <div>
                                ...
                                <li class="d-none d-lg-block">
                                    <div class="header-lang">
                                        ...
                                        <ul class="header-lang-list">
                                            <li><a href="home-2.html#!" class="hover-link" data-lang="En" data-title="English"><span>English</span></a></li>
                                            <li><a href="home-2.html#!" class="hover-link" data-lang="Sp" data-title="Spanish"><span>Spanish</span></a></li>
                                            <li><a href="home-2.html#!" class="hover-link" data-lang="It" data-title="Italian"><span>Italian</span></a></li>
                                            <li><a href="home-2.html#!" class="hover-link" data-lang="Uk" data-title="Ukraine"><span>Ukraine</span></a></li>
                                            <li><a href="home-2.html#!" class="hover-link" data-lang="Ru" data-title="Russian"><span>Russian</span></a></li>
                                        </ul>
                                    </div>
...
<div class="intro">
    <div class="intro-slider flickity-dots-absolute flickity-dots-white" data-flickity='{ "bgLazyLoad": 1, "bgLazyLoad": true, "fade": true, "prevNextButtons": false, "autoPlay": 7000, "pauseAutoPlayOnHover": false }'>
        <div class="intro-item">
            <div class="intro-item-img-right" data-flickity-bg-lazyload="assets/img/intro-img-r1.jpg"></div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="intro-box">
        ...
        <div class="intro-item">
            <div class="intro-item-img-right" data-flickity-bg-lazyload="assets/img/intro-img-r2.jpg"></div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="intro-box">
        ...
        <div class="intro-item">
            <div class="intro-item-img-right" data-flickity-bg-lazyload="assets/img/intro-img-r3.jpg"></div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="intro-box">
                ...
                <div class="reviews-container">
                    <div class="reviews-carusel reviews-carusel-wide reviews-carusel-th">
                        <div class="reviews-col">
                            <div class="reviews-item reviews-item-vertical item-style">
                        ...
                        <div class="reviews-col">
                            <div class="reviews-item reviews-item-vertical item-style">
                                <div class="reviews-item-text">
                                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis labore, nihil libero unde tempora adipisci fugiat, reprehenderit doloremque et eos voluptatem reiciendis pariatur nisi itaque hic ut velit aperiam beatae.</p>
                                </div>
                                <div class="reviews-item-header">
                                    <div class="reviews-item-info">
                    ...
                    <div class="reviews-thumb">
                        <div class="reviews-thumb-item active">
                            <div class="reviews-item-img">
                                <img data-src="assets/img/auth-img-1.jpg"
                                     class="lazy"
                        ...
                        <div class="reviews-thumb-item">
                            <div class="reviews-item-img">
                                <img data-src="assets/img/auth-img-2.jpg"
                                     class="lazy"
                                     src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                     alt="">
                            </div>
                        ...
                        <div class="reviews-thumb-item">
                            <div class="reviews-item-img">
                                <img data-src="assets/img/auth-img-3.jpg"
                                     class="lazy"
                                     src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                     alt="">
                            </div>
            ...
            <div class="row items">
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-7 item">
                    <div class="footer-item">
                        ...
                        <nav class="footer-nav">
                            <ul class="footer-mnu">
                                <li><a href="home-2.html#!" class="hover-link" data-title="DB Management"><span>DB Management</span></a></li>
                                <li><a href="home-2.html#!" class="hover-link" data-title="IOS/MacOS"><span>IOS/MacOS</span></a></li>
                                <li><a href="home-2.html#!" class="hover-link" data-title="Android Apps"><span>Android Apps</span></a></li>
                                <li><a href="home-2.html#!" class="hover-link" data-title="Windows Apps"><span>Windows Apps</span></a></li>
                                <li><a href="home-2.html#!" class="hover-link" data-title="UX & UI"><span>UX & UI</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="footer-contacts">
                            ...
                            <li>
                                ...
                                <div class="footer-contact-info">
                                    <a href="home-2.html#!" class="formingHrefTel">+1 323-913-4688</a>, <a href="home-2.html#!" class="formingHrefTel">+1 323-888-4554</a>
                                </div>
                            </li>
                            <li>

                        ...
                        <div class="col-xl-2 offset-xl-1 col-md-3 col-5 col-lg-2 item">
                            <div class="footer-item">
                                ...
                                <nav class="footer-nav">
                                    <ul class="footer-mnu">
                                        <li><a href="{{url('about-us')}}" class="hover-link" data-title="About Us"><span>About Us</span></a></li>
                                        <li><a href="{{url('services')}}" class="hover-link" data-title="Services"><span>Services</span></a></li>
                                        <li><a href="{{url('contact-us')}}" class="hover-link" data-title="Contact Us"><span>Contact Us</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
